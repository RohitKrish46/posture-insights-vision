...
cam = cv2.VideoCapture('./videos/pushup_2.mp4')
ret_val, image = cam.read()

# fourcc = cv2.VideoWriter_fourcc(*'mp4v')
# out = cv2.VideoWriter('./results/output_pushup.mp4', fourcc, 20.0, (270, 480))
...
while True:
    ...
    try:
        # Analyze workout
        hip_angle = analyze_workout(None, current_workout,
